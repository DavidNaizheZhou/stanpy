...
Zweigliedrige Stabkonstruktion - EX1 
====================================

Gegeben ist ein Tragwerk mit Belastung laut Abbildung.

.. figure:: static/EX1/system.PNG
    :align: center
    :figwidth: 400px
...
.. math::
    ...
    A_i = \iint_{A_i} dA_i \qquad A = \sum A_i
...
You can add a link to equations like the one above :eq:`test` by using ``:eq:``.
